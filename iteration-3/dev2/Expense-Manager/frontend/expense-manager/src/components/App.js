...
render() {
    return (
      <div>
        ...
        <Button bsStyle="success" bsSize="small" onClick={this.openModal}>Analyse</Button><br/>
        <SearchField placeholder="Search..." searchText="" onSearchClick={this.findById} classNames="test-class" />

    <table>
          <thead>
            <tr>
            <th></th>
            <th className='desc-col'>Id</th><
            ...
            <th className='button-col'>Analysis Result</th>
            </tr>
          </thead>
          <tbody>
            {
               this.state.data.map((exp) => {
                              ...
                              <td className='desc-col'>{exp.id}</td>
